...
body {
        ...
        //   document.getElementById('verifyImg').src='<?php echo U('Regi/verify');?>'+Math.random();  
        // }
        // </script>
    </head>
    <body>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="verify" name="verify" placeholder="Verify">
                         <img src="<?php echo U('Regi/verify/');?>" title="reflash verify" id="verifyImg" onClick="changeVerify()">
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <button type="submit" class="btn">Registered</button>
                        <a href="<?php echo U('Index/index');?>" type="button" class ="btn btn-primary">Back</a>
                    </div>
                </div>
            </form>
        </div>
